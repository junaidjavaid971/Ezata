...
class OnRouteCountDownLiveData : LiveData<CountDownData>() {
    ...
    companion object {
        private lateinit var instance: OnRouteCountDownLiveData
        ...
        fun getInstance(): OnRouteCountDownLiveData {
            instance = if (Companion::instance.isInitialized) instance else OnRouteCountDownLiveData()
            return instance
        }
    }
